...
const gigFormSchema = z.object({
  ...
  performances: z.array(z.object({
    ...
    time: z.string().regex(/^([01]\d|2[0-3]):([0-5]\d)$/, { message: 'Anna aika muodossa HH:MM.' }),
...
const AddGigForm = ({ isOpen, onOpenChange, onSuccess, gigToCopy }: AddGigFormProps) => {
  ...
  const mutation = useMutation({
    ...
    onSuccess: () => {
      toast({ title: 'Onnistui!', description: 'Uudet keikat lisätty onnistuneesti.' });
          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6 p-1">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <FormField 
                ...
                render={({ field }) => ( 
                  <FormItem>
                    <FormLabel>Kuvan Alt-teksti</FormLabel>
                    <FormControl>
                      <Textarea {...field} />
                    </FormControl>
                    <FormMessage />
              ...
              <FormField 
                ...
                render={({ field }) => ( 
                  <FormItem>
                    <FormLabel>Maan koodi</FormLabel>
                    <FormControl>
                      <Input {...field} />
                    </FormControl>
                    <FormMessage />
              ...
              <FormField 
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>Keikan tyyppi</FormLabel>
                  ...
                  <div key={field.id} className="flex items-center gap-2 p-3 border rounded-md">
                            ...
                            <PopoverTrigger asChild>
                              <FormControl>
                                ...
                                >
                                  ...
                                  {field.value ? format(field.value, 'd.M.yyyy') : <span>Valitse päivä</span>}
                                </Button>
                              </FormControl>
                            </PopoverTrigger>
                    ...
                    <FormField 
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormControl>
                            <Input className="w-[100px]" placeholder="HH:MM" {...field} />
                          </FormControl>
                          <FormMessage />
                        </FormItem>
                      )} 
